...
from services.diff_service import compare_local_remote_changes, _get_filtered_changed_files
# Setup test data
...
@patch('remote.remote_interface.RemoteInterface.get_latest_commit')
@patch('services.repo_mapper.get_remote_service')
@patch('git_utils.git_commands.get_merge_base')
